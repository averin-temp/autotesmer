...
-- Дамп структуры для таблица autotesmer_test.admin_notification
...
-- Дамп данных таблицы autotesmer_test.admin_notification: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица autotesmer_test.advertising
...
-- Дамп данных таблицы autotesmer_test.advertising: ~0 rows (приблизительно)
DELETE FROM `advertising`;
/*!40000 ALTER TABLE `advertising` DISABLE KEYS */;
INSERT INTO `advertising` (`id`, `phone`, `name`, `website`, `email`) VALUES
	(3, '+79068686776', 'Иван Иванович', 'http://hh.ru', 'test@iit.com');
...
-- Дамп данных таблицы autotesmer_test.auth_item: ~36 rows (приблизительно)
DELETE FROM `auth_item`;
/*!40000 ALTER TABLE `auth_item` DISABLE KEYS */;
INSERT INTO `auth_item` (`name`, `type`, `description`, `rule_name`, `data`, `created_at`, `updated_at`) VALUES
	('accessAdvertising', 2, 'Доступ к заявкам на рекламу', NULL, NULL, 1584271547, 1584271547),
	('accessArbitrage', 2, 'Доступ к арбитражу', NULL, NULL, 1584271547, 1584271547),
	('accessBackend', 2, 'Доступ к административному разделу', NULL, NULL, 1584271547, 1584271547),
	('accessBanners', 2, 'Доступ к баннерам', NULL, NULL, 1584271547, 1584271547),
	('accessCategories', 2, 'Доступ к категориям', NULL, NULL, 1584271547, 1584271547),
	('accessGroups', 2, 'Доступ к группам', NULL, NULL, 1584271547, 1584271547),
	('accessLK', 2, 'Доступ к личному кабинету', NULL, NULL, 1584271547, 1584271547),
	('accessMailing', 2, 'Доступ к рассылкам', NULL, NULL, 1584271547, 1584271547),
	('accessMailTemplates', 2, 'Доступ к почтовым шаблонам', NULL, NULL, 1584271547, 1584271547),
	('accessMenu', 2, 'Доступ к меню', NULL, NULL, 1584271547, 1584271547),
	('accessPackages', 2, 'Доступ к пакетам', NULL, NULL, 1584271547, 1584271547),
	('accessPages', 2, 'Доступ к страницам', NULL, NULL, 1584271547, 1584271547),
	('accessProfile', 2, 'Доступ к профилю', NULL, NULL, 1584271547, 1584271547),
	('accessPromocodes', 2, 'Доступ к промокодам', NULL, NULL, 1584271547, 1584271547),
	('accessRoles', 2, 'Доступ к ролям', NULL, NULL, 1584271547, 1584271547),
	('accessUsers', 2, 'Доступ к пользователям', NULL, NULL, 1584271547, 1584271547),
	('accessVerifications', 2, 'Доступ к проверкам документов', NULL, NULL, 1584271547, 1584271547),
	('createSiteReview', 2, 'Оставлять отзывы о сайте', NULL, NULL, 1584271547, 1584271547),
	('editAdvertising', 2, 'Удаление заявок на рекламу', NULL, NULL, 1584271547, 1584271547),
	('editArbitrage', 2, 'Редактирование арбитража', NULL, NULL, 1584271547, 1584271547),
	('editBanners', 2, 'Редактирование баннеров', NULL, NULL, 1584271547, 1584271547),
	('editCategories', 2, 'Редактирование категорий', NULL, NULL, 1584271547, 1584271547),
	('editGroups', 2, 'Редактирование групп', NULL, NULL, 1584271547, 1584271547),
	('editMailing', 2, 'Редактирование ролей', NULL, NULL, 1584271547, 1584271547),
	('editMailTemplates', 2, 'Редактирование почтовых шаблонов', NULL, NULL, 1584271547, 1584271547),
	('editMenu', 2, 'Управление меню', NULL, NULL, 1584271547, 1584271547),
	('editPackages', 2, 'Редактирование пакетов', NULL, NULL, 1584271547, 1584271547),
	('editPages', 2, 'Редактирование страниц', NULL, NULL, 1584271547, 1584271547),
	('editPromocodes', 2, 'Редактирование промокодов', NULL, NULL, 1584271547, 1584271547),
	('editRoles', 2, 'Редактирование ролей', NULL, NULL, 1584271547, 1584271547),
	('editUsers', 2, 'Редактирование пользователей', NULL, NULL, 1584271547, 1584271547),
	('editVerifications', 2, 'Управление проверкой документов', NULL, NULL, 1584271547, 1584271547),
	('Администратор', 1, 'Администратор', NULL, NULL, 1584271547, 1584271547),
	('Клиент', 1, 'Клиент', NULL, NULL, 1584271547, 1584271547),
	('Модератор', 1, 'Модератор', NULL, NULL, 1584271547, 1584271547),
	('Эксперт', 1, 'Эксперт', NULL, NULL, 1584271547, 1584271547);
...
-- Дамп данных таблицы autotesmer_test.auth_item_child: ~48 rows (приблизительно)
...
INSERT INTO `auth_item_child` (`parent`, `child`) VALUES
	...
	('Администратор', 'accessAdvertising'),
	('Администратор', 'createSiteReview'),
	('Администратор', 'editAdvertising'),
...
-- Дамп данных таблицы autotesmer_test.brief: ~0 rows (приблизительно)
DELETE FROM `brief`;
...
-- Дамп данных таблицы autotesmer_test.chat: ~0 rows (приблизительно)
DELETE FROM `chat`;
...
-- Дамп данных таблицы autotesmer_test.dial: ~0 rows (приблизительно)
DELETE FROM `dial`;
...
CREATE TABLE IF NOT EXISTS `notice_settings` (
  ...
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=476 DEFAULT CHARSET=utf16;
...
INSERT INTO `notice_settings` (`user_id`, `events`, `documents_approved`, `works_in_your_region`, `expertize_approved`, `client_created_appeal`, `wait_payment`, `card_registered`, `review_added`, `package_obtained`, `arbitration_closed`, `your_info_changed`, `new_request`, `admin_message`, `you_created_appeal`, `report_received`, `you_ordered_a_selection`, `you_made_a_deposit`, `you_have_secured_a_deal`, `you_confirmed_work`, `new_verification`) VALUES
	(475, b'1', b'1', b'1', b'1', b'1', b'1', b'1', b'1', b'1', b'1', b'1', b'1', b'1', b'1', b'1', b'1', b'1', b'1', b'1', b'1');
...
CREATE TABLE IF NOT EXISTS `notifications` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=197 DEFAULT CHARSET=utf16;
...
-- Дамп данных таблицы autotesmer_test.notification_types: ~27 rows (приблизительно)
...
INSERT INTO `notification_types` (`id`, `name`, `renderer`, `description`) VALUES
	...
	(53, 'expert_created_appeal', 'NoticeExpertCreatedAppeal', 'Эксперт открыл арбитраж');
...
-- Дамп данных таблицы autotesmer_test.payment: ~0 rows (приблизительно)
DELETE FROM `payment`;
...
-- Дамп данных таблицы autotesmer_test.requests: ~0 rows (приблизительно)
...
-- Дамп данных таблицы autotesmer_test.service: ~0 rows (приблизительно)
DELETE FROM `service`;
...
INSERT INTO `users` (`id`, `login`, `phone_reliable`, `card_id`, `password`, `firstname`, `family`, `busyness`, `lastname`, `email`, `created_at`, `updated_at`, `has_ip`, `has_ul`, `profile_vk`, `profile_facebook`, `profile_google`, `profile_twitter`, `phone`, `city_id`, `birthday`, `has_ip_or_ul`, `gender`, `active`, `activation_key`, `photo`, `resume`, `confirmed_email`, `confirmed_phone`, `about`, `text`, `status`, `category_auto`, `category_freight`, `category_moto`, `category_water`, `category_commerce`, `rating`, `profile_mailru`) VALUES
	(475, '', 0, 0, '1', 'admin', 'adminov', 1, 'adminovich', 'admin@mail.ru', '2020-03-15 16:25:47', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, '', 53, NULL, NULL, NULL, 1, NULL, NULL, NULL, 1, 0, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, NULL);
...
-- Дамп данных таблицы autotesmer_test.user_package: ~0 rows (приблизительно)
