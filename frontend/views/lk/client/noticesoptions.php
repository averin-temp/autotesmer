                ...
                <div class="lk_expert_body">
                    <div class="lk_expert_body_packejes">
                        ...
                        <div class="lk_expert_body_packejes_tabs">
                            <ul>
                                <li><a href="<?= Url::to(['/lk/notices']) ?>">Уведомления</a></li>
                                <li class="active"><a href="<?= Url::to(['/lk/noticesoptions']) ?>">Настройка уведомлений</a></li>
                            </ul>
                        </div>
                        <div class="lk_expert_body_packejes_tabs_body">
                            <div class="lk_expert_body_sets">
                                <form action="<?= Url::to(['/lk/noticesoptions']) ?>" method="post">
                                <div class="row">
                                    <div class="col-md-12">
