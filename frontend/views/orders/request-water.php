    ...
    <div class="container">
            ...
            <div class="col-md-10">
                <div class="form_catli_top">
                    <ul>
                        ...
                        <li><img src="/img/icons/ccats/2.png" alt=""><img src="/img/icons/ccats/2_h.png" alt=""><span>Грузовая</span></li>
                        ...
                        <li class="active"><img src="/img/icons/ccats/5.png" alt=""><img src="/img/icons/ccats/5_h.png" alt=""><span>Водный транспорт</span></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <form action="">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="f_group">
                        <input type="text" placeholder="Любая" required="">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="f_group">
            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="f_group">
                        <span class="f_group_labl">Год выпуска</span>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="f_group">
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    <div class="form_catli">
                        <ul>
                            <li><img src="/img/icons/icon_cats/1.png" alt="">Моторная лодка</li>
                            <li><img src="/img/icons/icon_cats/2.png" alt="">Катера и яхты</li>
                            <li><img src="/img/icons/icon_cats/3.png" alt="">Надувные лодки</li>
                            <li><img src="/img/icons/icon_cats/4.png" alt="">Гидроциклы</li>
                            <li><img src="/img/icons/icon_cats/5.png" alt="">Весельные лодки</li>
                            <li><img src="/img/icons/icon_cats/6.png" alt="">Каяки и каноэ</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="reg_exp_page_3332 ccheck">
                        ...
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="customCheck2">Мощность</label>
                        </div>
                    </div>
                </div>
            </div>
