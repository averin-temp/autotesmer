        ...
        <form action="">
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    <div class="form_catli">
                        <ul>
                            <li><img src="/img/icons/icon_cats/7.png" alt="">Фургон</li>
                            <li class="active"><img src="/img/icons/icon_cats/8.png" alt="">Грузовик</li>
                            <li><img src="/img/icons/icon_cats/9.png" alt="">Сдельный тягач</li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    <div class="form_catli">
                        <ul>
                            <li>Заднеприводный с подключаемым передним</li>
                            <li class="active">Задний</li>
                            <li>Передний</li>
                            <li>Полный</li>
                            <li>Полный подключаемый</li>
                            <li>Постоянный привод на все колеса</li>
                        </ul>
                    </div>
                </div>
            </div>
