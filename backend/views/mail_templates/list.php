...
?>
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Почтовые шаблоны</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <?php if($report = Yii::$app->session->getFlash('mail-template-operation')): ?>
                            ...
                            <?php foreach($templates as $template): /** @var $template \common\models\MailTemplate */ ?>
                                ...
                                <tr>
                                    <td>
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" style="cursor: pointer" value="<?= $template->id ?>">
                                            </label>
                                        </div>
                                    </td>
                                    <td><?= $template->name ?></td>
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            <a href="<?= Url::to(['/mail_templates/edit', 'id' => $template->id]) ?>" class="btn btn-success"><i class="fa fa-edit"></i></a>
                                            <a href="<?= Url::to(['/mail_templates/delete', 'id' => $template->id]) ?>" class="btn btn-danger delete-row"><i class="fa fa-trash"></i></a>
                                        </div>
                                    </td>
                                </tr>
