...
<?= $this->render('//modals/dialog') ?>
    ...
    <section class="content">
        ...
        <?php if($report = Yii::$app->session->getFlash('pages-table')): ?>
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <table id="pages-table" class="table table-bordered table-striped">
                            ...
                            <tbody>
                            <?php foreach($pages as $page): /** @var $page common\models\Page */?>
                            <tr>
                                <td>
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" style="cursor: pointer" value="<?= $page->id ?>" >
                                        </label>
                                    </div>
                                </td>
                                <td><?= $page->name ?></td>
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        <a href="<?= Url::to(['/pages/edit', 'id' => $page->id ]) ?>" class="btn btn-success"><i class="fa fa-edit"></i></a>
                                        <a href="<?= Url::to(['/pages/delete', 'id' => $page->id]) ?>" class="btn btn-danger delete-row"><i class="fa fa-trash"></i></a>
                                    </div>
                                </td>
                            </tr>
                            <?php endforeach; ?>
