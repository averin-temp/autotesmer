...
?>
    ...
    <section class="content">
        ...
        <?php if($report = Yii::$app->session->getFlash('package-table')): ?>
            <div class="alert <?= $report['status'] ? "alert-success" : "alert-danger" ?> alert-dismissable">
                        ...
                        <table id="package-table" class="table table-bordered table-striped">
                            ...
                            <tr>
                                <td>
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" style="cursor: pointer" value="<?= $package->id ?>">
                                        </label>
                                    </div>
                                </td>
                                <td><?= $package->name ?></td>
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        <a href="<?= Url::to(['packages/edit', 'id' => $package->id ]) ?>" class="btn btn-success"><i class="fa fa-edit"></i></a>
                                        <a href="<?= Url::to(['packages/delete', 'id' => $package->id]) ?>" class="btn btn-danger delete-row"><i class="fa fa-trash"></i></a>
                                    </div>
                                </td>
                            </tr>
                            <?php endforeach; ?>
